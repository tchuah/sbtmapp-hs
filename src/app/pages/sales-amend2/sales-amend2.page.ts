...
@Component({
  selector: 'app-sales-amend2',
  templateUrl: './sales-amend2.page.html',
  styleUrls: ['./sales-amend2.page.scss'],
})
export class SalesAmend2Page implements OnInit, OnDestroy {
  ...
  selectSales(Id) {
    ...
    if (this.status !== 8 && this.status !== 9) {
      ...
      this.sbtForm.get('IsLoan').enabled;
      this.sbtForm.get('IsBodyWork').enabled;
    }
