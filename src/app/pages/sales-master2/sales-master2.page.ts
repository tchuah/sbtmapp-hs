...
@Component({
  selector: 'app-sales-master2',
  templateUrl: './sales-master2.page.html',
  styleUrls: ['./sales-master2.page.scss'],
})
export class SalesMaster2Page implements OnInit, OnDestroy {
  ...
  searchValue = '';
  searchRawValue = '';
  currentStatus: number = -98;
  currentRawStatus: number = -98;
  noData = true;
  dataJson = [];
  ...
  async apiCall(isFirstLoad, e) {
    ...
    this.api.httpSp(`Main/ACT_LookupAppSalesMaster?KeyAction=FINANCE&offset=${this.pageNumData * this.pageShowNumData}&fetch=${this.pageShowNumData}`,  {SearchValue: this.searchValue, FilterStatus: this.currentStatus})
