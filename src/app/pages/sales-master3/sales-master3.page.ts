...
@Component({
  selector: 'app-sales-master3',
  templateUrl: './sales-master3.page.html',
  styleUrls: ['./sales-master3.page.scss'],
})
export class SalesMaster3Page implements OnInit, OnDestroy {
  ...
  async apiCall(isFirstLoad, e) {
    ...
    this.api.httpSp(`Main/ACT_LookupAppSalesMaster?KeyAction=SALESMAN&offset=${this.pageNumData * this.pageShowNumData}&fetch=${this.pageShowNumData}`,  {SearchValue: this.searchValue, FilterStatus: this.currentStatus})
