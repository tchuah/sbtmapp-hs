...
@Component({
  selector: 'app-sales-scenario',
  templateUrl: './sales-scenario.page.html',
  styleUrls: ['./sales-scenario.page.scss'],
})
export class SalesScenarioPage implements OnInit, OnDestroy {
